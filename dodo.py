...
def task_generate_meta_schemas():
    ...
    for example in examples:
        ...
        yield {
            "name": name,
            "file_dep": [schema.schema.file_path for schema in example.schema_info]
            + [
            ...
            "targets": [schema.meta_schema_path for schema in example.schema_info],
...
def task_validate_schemas():
    ...
    for example in examples:
        ...
        yield {
            ...
            "file_dep": [schema.schema.file_path for schema in example.schema_info]
            + [schema.meta_schema_path for schema in example.schema_info]
...
def task_generate_json_schemas():
    ...
    for example in examples:
        ...
        yield {
            ...
            "targets": [schema.json_schema_path for schema in example.schema_info],
...
def task_validate_example_files():
    ...
    for example in examples:
        ...
        yield {
            "name": name,
            "file_dep": [schema.json_schema_path for schema in example.schema_info]
            + example.examples
